<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="RejectedAstrologers.aspx.cs" Inherits="AstroApp.Admin.RejectedAstrologers" %>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                    <h4 class="page-title">Rejected Astrologers</h4>
                </div>
            </div>
        </div>
