<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AstrologerLogin.aspx.cs" Inherits="AstroApp.AstrologerLogin" %>
        ...
        <div class="login-wrapper d-flex align-items-center justify-content-center">
            <div class="custom-container">
                ...
                <div class="login-meta-data px-4 text-center">
                    <p class="mt-3 mb-0 ">
                        Don't Have Account <a href="AstrologerRegistration.aspx">Register Here</a>
                    </p>
                    <p class="mt-3 mb-0 ">
