<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Chat.aspx.cs" Inherits="AstroApp.Chat" %>
                ...
                <div class="header-content position-relative d-flex align-items-center justify-content-between">
                    <div class="chat-user--info d-flex align-items-center">
                        ...
                        <div class="user-thumbnail-name">
                            <asp:Image ID="ImgAstrologer" runat="server" />
                            <div class="info ms-1">
                                <p>
                                    <asp:Literal ID="lblAstrologerName" runat="server"></asp:Literal>
                                </p>
            ...
            <div class="container">
                ...
                <div class="chat-content-wrap" id="chat-content">
                    ...
                    <asp:Repeater ID="rptChat" runat="server">
                        <ItemTemplate>
                            <div class="single-chat-item <%# Convert.ToInt32(Eval("sender_id")) ==Convert.ToInt32(hdnUserID.Value) ? "outgoing" : "incoming" %> <%# GetReadUnreadClass(Container.DataItem) %>" data-id="<%# Eval("message_id") %>">
                                ...
                                <div class="user-message">
                                    ...
                                    <div class="message-time-status">
                                        <div class="sent-time"><%# Eval("created_at", "{0:dd/MM/yyyy hh:mm:ss}") %></div>
                                        <div class="sent-status <%# Convert.ToBoolean(Eval("is_read")) ? "seen" : "" %> <%# Convert.ToInt32(Eval("sender_id")) ==Convert.ToInt32(hdnUserID.Value) ? "" : "d-none" %>">
            ...
            <div class="container h-100">
                <div class="chat-footer-content h-100 d-flex align-items-center">
                    <div class="chat-form">
                        ...
                        <%--<div class="dropup me-2 ms-2">
                            <button class="btn btn-add-file dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="true">
                                <i class="bi bi-plus-circle"></i>
                            </button>
                            <ul class="dropdown-menu" style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate(0px, -34px);" data-popper-placement="top-start">
    ...
    <script>
        $(function () {
            ...
            chat.client.receiveMessage = function (messageId, senderId, message, messageType) {
                var messageHtml = '';
                var currentUserId = <%= hdnUserID.Value %>;
...
${mediaContent}
        ...
        <div class="message-time-status">
            ...
            $(function () {
                ...
                async function sendVoiceMessage(audioBlob) {
                    ...
                    reader.onload = function (e) {
                        ...
                        var receiverId = $("#hdnAstrologerID").val();
                        var isAstrologer = false;
            ...
            $.connection.hub.start().done(function () {
                ...
                chat.server.registerConnection($("#hdnUserID").val(), $("#hdnAstrologerID").val(), false); // `false` if user

                // On chat load, check all unread messages and mark them as read
                ...
                $("#btnSend").click(function () {
                    ...
                    chat.server.sendMessage(senderId, receiverId, message, false); // `false` indicates the sender is a user
