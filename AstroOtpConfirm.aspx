<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AstroOtpConfirm.aspx.cs" Inherits="AstroApp.AstroOtpConfirm" %>
                ...
                <div class="otp-verify-form mt-4">
                    <div action="home.html">
                        <div class="input-group mb-3 otp-input-group">
                            ...
                            <asp:TextBox ID="txtOTP1" ValidationGroup="a" CssClass="form-control otp-box" MaxLength="1" placeholder="-" runat="server"></asp:TextBox>
                            <asp:TextBox ID="txtOTP2" ValidationGroup="a" CssClass="form-control otp-box" MaxLength="1" placeholder="-" runat="server"></asp:TextBox>
                            <asp:TextBox ID="txtOTP3" ValidationGroup="a" CssClass="form-control otp-box" MaxLength="1" placeholder="-" runat="server"></asp:TextBox>
                            <asp:TextBox ID="txtOTP4" ValidationGroup="a" CssClass="form-control otp-box" MaxLength="1" placeholder="-" runat="server"></asp:TextBox>
                        </div>
